...
url = 'https://www.kaarimarket.com/just-in?sorting=new-arrival'
...
if product_list:
    ...
    for div in product_divs:
        ...
        if link:
            ...
            description_elements = product_soup.find('div', class_='product-text').find_all('li')
